...
print'<html>';
print'<head> </head>';
print '<h2><font color="blue">HYDROPHILIC INTERACTION</font></h2>';
...
if($_=~/^ATOM/)
{
if((substr($_,17,3) eq "ARG") || (substr($_,17,3) eq "ASN") || (substr($_,17,3) eq "ASP") || (substr($_,17,3) eq "GLN") || (substr($_,17,3) eq "GLU") || (substr($_,17,3) eq "HIS") || (substr($_,17,3) eq "LYS") || (substr($_,17,3) eq "SER") || (substr($_,17,3) eq "THR"))
{
